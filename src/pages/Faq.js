    ...
    <>
      ...
      <PageWrapper>
        ...
        <FaqDetails>
          ...
          <FaqText>
            All vaccines go through a long and thorough process of development
            and testing before they are licensed for use. It can take as much as
            20 years for a vaccine to go from first concept to being licensed.
          </FaqText>
        </FaqDetails>
        <FaqDetails>
        ...
        <FaqDetails>
          ...
          <FaqText>
            Combination vaccines protects you against more than one disease with
            a single shot. They reduce the number of shots and office visits you
            would need.
          </FaqText>
        </FaqDetails>
